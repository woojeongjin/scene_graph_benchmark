...
def main():
    ...
    parser.add_argument('--imgroot', type=str,
                        default='/home/woojeong/COCO/Image/')
    parser.add_argument('--split', type=str, default='val2014', choices=['train2014', 'test2015', 'val2014'])
    ...
    coco_dir = Path(args.imgroot).resolve()
    img_dir = coco_dir.joinpath(args.split)
